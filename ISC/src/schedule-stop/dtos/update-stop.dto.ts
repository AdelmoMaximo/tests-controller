...
export class UpdateScheduledStopDto extends OmitType(ScheduleStopEntity,['scheduled_stop_id','scheduled_stop_date_created','scheduled_stop_code','scheduled_stop_is_actvie','scheduled_stop_users_created']){
